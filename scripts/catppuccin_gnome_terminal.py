...
arg_parser.add_argument(
    ...
    "--local",
    action="store",
    help="Path to a local Catppuccin palette.json (optional)",
)
...
if args.local is None:
    ...
    try:
        with open(args.local, encoding="utf-8") as local_palette:
...
# Hardcoded UUIDs for each flavor. These provide stable profile IDs so re-runs
# update the same profiles instead of creating duplicates.
uuids = {
